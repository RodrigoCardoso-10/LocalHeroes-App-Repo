...
const initialReviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Did an amazing job with my garden. Very knowledgeable and professional.",
    date: "2024-02-08",
    reviewedUserId: "demo-user-3",
  },
  {
    id: "4",
