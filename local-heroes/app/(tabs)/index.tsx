      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.searchContainer}>
          ...
          {searchQuery ? (
            ...
            <TouchableOpacity style={styles.searchIcon} onPress={handleSearch} activeOpacity={0.7}>
          ...
          <View style={styles.jobCardsContainer}>
            {loading ? (
              ...
              <View style={styles.noJobsContainer}>
                ...
                <TouchableOpacity style={styles.browseJobsButton} onPress={() => router.push('/(tabs)/jobs')}>
